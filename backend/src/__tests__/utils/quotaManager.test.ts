// Note: Named imports are for type checking only - actual functions are imported via require() after jest.resetModules()
// This file uses require() for module isolation with jest.resetModules() - an intentional testing pattern
/* eslint-disable @typescript-eslint/no-require-imports */
import type {} from '../../utils/quotaManager';
...
describe('Quota Manager', () => {
  ...
  describe('initializeQuota', () => {
    it('should initialize quota for a location', () => {
      const { initializeQuota: init, getQuotaStatus: getStatus } = require('../../utils/quotaManager');
  ...
  describe('updateQuota', () => {
    it('should increase quota usage', () => {
      const { updateQuota: update, getQuotaStatus: getStatus } = require('../../utils/quotaManager');
  ...
  describe('integration scenarios', () => {
    it('should handle typical upload workflow', () => {
      const { checkQuota: check, updateQuota: update, getQuotaStatus: getStatus } = require('../../utils/quotaManager');
