...
describe('Configuration', () => {
  describe('Local Storage Paths', () => {
    it('should return empty array when LOCAL_STORAGE_PATHS not set', () => {
    ...
    it('should return copy of empty array to prevent mutation', () => {
      updateLocalStoragePaths([]);
      const paths1 = getLocalStoragePaths();
      paths1.push('/new/path');
      const paths2 = getLocalStoragePaths();
  ...
  describe('S3 Configuration', () => {
    ...
    it('should update S3 configuration', () => {
      updateS3Config('newKeyId', 'newSecret', 'us-west-2', 'https://new-endpoint.com', 'new-bucket');
      const config = getS3Config();
